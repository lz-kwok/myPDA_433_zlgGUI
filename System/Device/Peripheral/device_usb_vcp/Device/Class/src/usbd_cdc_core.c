...
static uint8_t  usbd_cdc_DataIn (void *pdev, uint8_t epnum)
{
  ...
  if (USB_Tx_State == 1)
  {
    ...
    {
      if(APP_Rx_ptr_out > APP_Rx_ptr_in) //APP_Rx_ptr_in已经绕了一圈
      {
      ...
      if (APP_Rx_length > CDC_DATA_IN_PACKET_SIZE)
      {
        if(flag)
        {
          ...
          if(Len > APP_RX_DATA_SIZE)// #define APP_RX_DATA_SIZE 2048
          {
            /////////////////////需要添加信息///////////////////////
...
//  if(USB_Rx_Cnt > 63)
//  {
//    Cnt_quotient = USB_Rx_Cnt/63;
//    Cnt_Remain = USB_Rx_Cnt%63;
//    
//    for(i=0;i<Cnt_quotient;i++)
//    {
//       /* USB data will be immediately processed, this allow next USB traffic being 
//       NAKed till the end of the application Xfer */
//       APP_FOPS.pIf_DataRx(USB_Rx_Buffer, 63);
//  
//       /* Prepare Out endpoint to receive next packet */
//       DCD_EP_PrepareRx(pdev,
//                         CDC_OUT_EP,
...
//     /* USB data will be immediately processed, this allow next USB traffic being 
//     NAKed till the end of the application Xfer */
//     APP_FOPS.pIf_DataRx(USB_Rx_Buffer, Cnt_Remain);
//
//     /* Prepare Out endpoint to receive next packet */
//     DCD_EP_PrepareRx(pdev,
//                       CDC_OUT_EP,
